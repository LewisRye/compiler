...
public class SimpleLangParser extends Parser {
	...
	public static final int
		...
		More=9, LessEq=10, MoreEq=11, Plus=12, Times=13, Minus=14, Divide=15, 
		And=16, Or=17, Xor=18, Assign=19, Print=20, Space=21, NewLine=22, Skip=23, 
		If=24, Then=25, Else=26, While=27, Do=28, Repeat=29, Until=30, IntType=31, 
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'while'", "'do'", "'repeat'", "'until'", "'int'", "'bool'", "'unit'"
		};
	}
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"Less", "More", "LessEq", "MoreEq", "Plus", "Times", "Minus", "Divide", 
	...
	public static class ReassignExprContext extends ExpContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof SimpleLangListener ) ((SimpleLangListener)listener).enterReassignExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof SimpleLangListener ) ((SimpleLangListener)listener).exitReassignExpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
	...
	public final ExpContext exp() throws RecognitionException {
		...
		try {
			...
			case 7:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 135995064338L) != 0)) {
					{
					setState(86);
