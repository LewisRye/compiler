...
public class SimpleLangCodeGenerator extends AbstractParseTreeVisitor<String> implements SimpleLangVisitor<String> {
    ...
    @Override
    public String visitProg(SimpleLangParser.ProgContext ctx) {
    ...
    @Override
    public String visitTyped_idfr(SimpleLangParser.Typed_idfrContext ctx) {
        throw new RuntimeException("Should not be here!");
    }

    @Override
    public String visitType(SimpleLangParser.TypeContext ctx) {
        throw new RuntimeException("Should not be here!");
    }
    ...
    @Override
    public String visitBlock(SimpleLangParser.BlockContext ctx) {
    ...
    @Override
    public String visitAssignExpr(SimpleLangParser.AssignExprContext ctx) {

        StringBuilder sb = new StringBuilder();

        sb.append(visit(ctx.exp()));

        localVars.put(ctx.Idfr().getText(), 4 + 8 + localVars.size() * 4);
    ...
    @Override
    public String visitBinOpExpr(SimpleLangParser.BinOpExprContext ctx) {
    ...
    @Override
    public String visitInvokeExpr(SimpleLangParser.InvokeExprContext ctx) {
    ...
    @Override
    public String visitBlockExpr(SimpleLangParser.BlockExprContext ctx) {
        return visit(ctx.block());
    }

    @Override
    public String visitIfExpr(SimpleLangParser.IfExprContext ctx) {
        StringBuilder sb = new StringBuilder();
    ...
    public String visitWhileExpr(SimpleLangParser.WhileExprContext ctx) {
        ...
        String condLabel = String.format("label_%d", labelCounter++);
        String stmtLabel = String.format("label_%d", labelCounter++);
    ...
    @Override
    public String visitPrintExpr(SimpleLangParser.PrintExprContext ctx) {
    ...
    @Override
    public String visitSpaceExpr(SimpleLangParser.SpaceExprContext ctx) {
    ...
    @Override
    public String visitIdExpr(SimpleLangParser.IdExprContext ctx) {
        StringBuilder sb = new StringBuilder();
    ...
    @Override
    public String visitIntExpr(SimpleLangParser.IntExprContext ctx) {
        StringBuilder sb = new StringBuilder();
    ...
    @Override
    public String visitEqBinop(SimpleLangParser.EqBinopContext ctx) {
        throw new RuntimeException("Should not be here!");
    }

    @Override
    public String visitLessBinop(SimpleLangParser.LessBinopContext ctx) {
        throw new RuntimeException("Should not be here!");
    }
    ...
    @Override
    public String visitLessEqBinop(SimpleLangParser.LessEqBinopContext ctx) {
        throw new RuntimeException("Should not be here!");
    }
    ...
    @Override
    public String visitPlusBinop(SimpleLangParser.PlusBinopContext ctx) {
        throw new RuntimeException("Should not be here!");
    }

    @Override
    public String visitMinusBinop(SimpleLangParser.MinusBinopContext ctx) {
        throw new RuntimeException("Should not be here!");
    }

    @Override
    public String visitTimesBinop(SimpleLangParser.TimesBinopContext ctx) {
        throw new RuntimeException("Should not be here!");
    }
